    ...
    vm.liveItems = [
        ...
        
            {
        	...
        	},
             {
               ...
               "formatFunction":  function(data, self) { return vm.accYFormatData(data, self) }, //KS fixed bug  accX --> accY
               "size": {sizeX: 2, sizeY: 1 },
               "noHeader": true,
               "type": "accelerometer"
        	},
             {
               ...
               "formatFunction":  function(data, self) { return vm.accZFormatData(data, self) }, // KS fixed bug accX --> accZ
               "size": {sizeX: 2, sizeY: 1 },
               "noHeader": true,
               "type": "accelerometer"
        	},
